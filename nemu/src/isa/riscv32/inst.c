...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(dest) = SEXT(src1, 64) * SEXT(src2, 64) & 0xffffffff);
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(dest) = SEXT(src1, 64) * SEXT(src2, 64) >> 32);
  //INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulsu  , R, R(dest) = (int64_t)src1 * (uint64_t)src2 >> 32);
  //INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulu   , R, R(dest) = (uint64_t)src1 * (uint64_t)src2 >> 32);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = src1 / (sword_t)src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(dest) = src1 / src2);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(dest) = src1 % (sword_t)src2);
